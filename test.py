...
# 언어 선택
selected_language = "ko"  # 기본 언어: 한국어
...
def create_input_text_button():
    ...
    generate_button = ttk.Button(
        canvas,
        text="다 적은 후, 저를 눌러 들어보세요." if selected_language == "ko" else "After writing, press me to listen.",
        style="TButton",
...
def create_dream_input_text_button():
    ...
    next_button = ttk.Button(
        canvas,
        text="꿈을 들려주세요." if selected_language == "ko" else "Please tell me your dream.",
        style="TButton",
